...
# gem3
#client  = MongoClient('mongodb://10.208.23.165:27017/')
db=client['media-db']
...
def fetchEn():
    ...
    #cursor=collection.find({'$and':[{'entities':{"$exists":False}},{'publishedDate':{'$gte':'2021-01-10'}}]},no_cursor_timeout=True).batch_size(50)
